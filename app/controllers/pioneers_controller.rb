class PioneersController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @pioneer.save
        format.html { redirect_to pioneer_url(@pioneer), notice: "Pioneer was successfully created." }
  ...
  def update
    respond_to do |format|
      if @pioneer.update(pioneer_params)
        format.html { redirect_to pioneer_url(@pioneer), notice: "Pioneer was successfully updated." }
